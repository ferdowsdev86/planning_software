...
import { SchedulerProBase as x } from "@bryntum/schedulerpro";
  ...
  setup(z, { expose: g, emit: m }) {
    ...
    return f("teleports", i), S(() => {
      ...
      n.value = o.createWidget({
        ...
        toRaw: D
      }), o.relayStores(t.data, n.value);
      const s = (e, C) => y(() => t.props[e], C);
      o.watchProps(n.value, l, s);
    }), E(() => {
      n.value?.destroy?.();
    }), g({
      instance: n,
...
//# sourceMappingURL=CYn0v67l.js.map
