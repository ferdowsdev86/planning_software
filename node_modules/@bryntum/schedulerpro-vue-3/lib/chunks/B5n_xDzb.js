import { defineComponent as h, ref as r, provide as u, onMounted as g, getCurrentInstance as y, toRaw as b, onBeforeUnmount as f, openBlock as k, createElementBlock as S, watch as C } from "vue";
import { CostAccrualField as x } from "@bryntum/schedulerpro";
import { WrapperHelper as o } from "../helper/WrapperHelper.js";
const A = /* @__PURE__ */ h({
  __name: "BryntumCostAccrualField",
  props: {
    adopt: {},
    align: {},
    alignSelf: {},
  ...
  setup(O, { expose: c, emit: s }) {
    ...
    return u("teleports", a), g(() => {
      const i = y();
      e.value = o.createWidget({
        me: i,
        widgetData: n,
        emit: p,
        element: t.value,
...
//# sourceMappingURL=B5n_xDzb.js.map
