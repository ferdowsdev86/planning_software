import { defineComponent as f, ref as u, provide as R, onMounted as h, getCurrentInstance as F, toRaw as b, onBeforeUnmount as T, openBlock as n, createElementBlock as c, createElementVNode as w, Fragment as D, renderList as S, createBlock as g, Teleport as M, resolveDynamicComponent as E, mergeProps as x, toHandlers as k, watch as v } from "vue";
import { ResourceUtilization as y } from "@bryntum/schedulerpro";
import { WrapperHelper as o } from "../helper/WrapperHelper.js";
const H = {
  ref: "teleportsHolder",
  style: { display: "none" }
}, P = /* @__PURE__ */ f({
  __name: "BryntumResourceUtilization",
  props: {
    adopt: {},
  ...
  setup(B, { expose: d, emit: m }) {
    ...
    return R("teleports", i), h(() => {
      ...
      w("div", H, [
        (n(!0), c(D, null, S(i.value.values(), (e) => (n(), g(M, {
          key: e.key,
          to: e.to
        }, [
          (n(), g(E(e.is), x({
...
//# sourceMappingURL=DHLzCm58.js.map
