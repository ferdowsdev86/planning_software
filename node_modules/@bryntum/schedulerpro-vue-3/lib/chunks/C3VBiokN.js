import { defineComponent as h, ref as r, provide as u, onMounted as g, getCurrentInstance as b, toRaw as y, onBeforeUnmount as f, openBlock as k, createElementBlock as x, watch as C } from "vue";
import { EndDateField as E } from "@bryntum/schedulerpro";
import { WrapperHelper as l } from "../helper/WrapperHelper.js";
const D = /* @__PURE__ */ h({
  __name: "BryntumEndDateField",
  props: {
    adopt: {},
    align: {},
    alignSelf: {},
  ...
  setup(w, { expose: s, emit: c }) {
    ...
    return u("teleports", a), g(() => {
      ...
      const o = (d, m) => C(() => n.props[d], m);
      l.watchProps(e.value, i, o);
    }), f(() => {
      e.value?.destroy?.();
    }), s({
      instance: e,
...
//# sourceMappingURL=C3VBiokN.js.map
