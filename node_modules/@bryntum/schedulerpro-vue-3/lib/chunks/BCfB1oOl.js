...
import { ResourceGrid as B } from "@bryntum/schedulerpro";
import { WrapperHelper as o } from "../helper/WrapperHelper.js";
const H = {
  ref: "teleportsHolder",
  style: { display: "none" }
}, O = /* @__PURE__ */ m({
  __name: "BryntumResourceGrid",
  props: {
    adopt: {},
    alignSelf: {},
  ...
  setup(T, { expose: p, emit: g }) {
    ...
    return R("teleports", a), b(() => {
      ...
      const s = (e, C) => k(() => t.props[e], C);
      o.watchProps(r.value, i, s);
    }), h(() => {
      r.value?.destroy?.();
    }), p({
      instance: r,
      ...
      E("div", H, [
        (l(!0), u(S, null, D(a.value.values(), (e) => (l(), c(M, {
          ...
          }, { ref_for: !0 }, e.bind, { "data-vue": "" }, v(e.on)), null, 16, ["data-key", "data-generation"]))
        ], 8, ["to"]))), 128))
      ], 512)
    ], 512));
  }
...
//# sourceMappingURL=BCfB1oOl.js.map
