import type { AlignSpec, Base, ButtonListeners, Color, ContainerItemConfig, DomConfig, KeyMapConfig, MaskConfig, MenuConfig, MenuItemEntry, PopupConfig, ReactJSX, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, VueConfig, Widget } from '@bryntum/schedulerpro';
