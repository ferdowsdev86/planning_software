import type { AlignSpec, Base, Color, ContainerItemConfig, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TextAreaPickerFieldListeners, TooltipConfig, Widget } from '@bryntum/schedulerpro';
