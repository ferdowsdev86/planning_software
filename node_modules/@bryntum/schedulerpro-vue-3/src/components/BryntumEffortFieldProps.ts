import type { AlignSpec, Base, Color, ContainerItemConfig, Duration, DurationConfig, DurationUnit, EffortFieldListeners, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
