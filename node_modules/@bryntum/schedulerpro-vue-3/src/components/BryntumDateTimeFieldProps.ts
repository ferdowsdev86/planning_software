import type { AlignSpec, Base, Color, ContainerItemConfig, DateFieldConfig, DateTimeFieldListeners, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TimeFieldConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
