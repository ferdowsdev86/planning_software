import type { AlignSpec, Base, Color, ContainerItemConfig, Field, FieldContainerConfig, FieldTriggerConfig, FileFieldListeners, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
