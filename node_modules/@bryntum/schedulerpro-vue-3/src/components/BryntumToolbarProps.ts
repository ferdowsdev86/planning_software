import type { AlignSpec, Base, ClickRepeaterConfig, Color, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Model, ReactJSX, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolConfig, ToolbarItems, ToolbarListeners, TooltipConfig, VueConfig, Widget } from '@bryntum/schedulerpro';
