import type { AlignSpec, Base, Color, Duration, DurationConfig, Field, KeyMapConfig, MaskConfig, Model, Rectangle, TabConfig, TimelineBase, ViewPresetComboListeners, Widget } from '@bryntum/schedulerpro';
