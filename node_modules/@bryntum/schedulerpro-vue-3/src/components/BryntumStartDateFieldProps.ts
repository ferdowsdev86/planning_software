import type { AlignSpec, Base, Color, ContainerItemConfig, DatePickerConfig, DurationConfig, EventModel, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, ProjectModel, Rectangle, StartDateFieldListeners, TabConfig, TimeField, TooltipConfig, Widget } from '@bryntum/schedulerpro';
