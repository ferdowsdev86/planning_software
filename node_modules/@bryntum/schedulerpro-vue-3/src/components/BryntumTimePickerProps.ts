import type { AlignSpec, Base, Color, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, MenuItemEntry, Model, ReactJSX, Rectangle, Scroller, ScrollerConfig, TabConfig, TimePickerListeners, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/schedulerpro';
