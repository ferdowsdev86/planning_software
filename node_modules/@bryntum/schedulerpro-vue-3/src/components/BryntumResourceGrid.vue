<!-- Vue 3 wrapper for Bryntum ResourceGrid -->
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof ResourceGrid>({
        me,
        widgetData,
        emit,
