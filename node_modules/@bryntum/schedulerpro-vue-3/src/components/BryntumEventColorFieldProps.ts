import type { AlignSpec, Base, ColorDescriptor, ContainerItemConfig, EventColorFieldListeners, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
