import type { AlignSpec, Base, Color, ContainerItemConfig, DateFieldListeners, DatePickerConfig, DurationConfig, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, TabConfig, TimeField, TooltipConfig, Widget } from '@bryntum/schedulerpro';
