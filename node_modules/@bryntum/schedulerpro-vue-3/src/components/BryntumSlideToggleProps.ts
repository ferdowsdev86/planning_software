import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainerConfig, FieldTriggerConfig, KeyMapConfig, MaskConfig, Rectangle, SlideToggleListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
