...
const
  ...
  disableRootCause = ['bigdataset', 'code', 'csp', 'norootcause', 'screenshot'],
...
const bryntumUrl = 'https://bryntum.com',
  ...
  defaultTheme = (_globalThis$matchMedi = globalThis.matchMedia) !== null && _globalThis$matchMedi !== undefined && (_globalThis$matchMedi = _globalThis$matchMedi.call(globalThis, '(prefers-contrast: more)')) !== null && _globalThis$matchMedi !== undefined && _globalThis$matchMedi.matches ? 'high-contrast-light' : 'svalbard-light',
  {
    queryString
  } = BrowserHelper,
...
class Shared extends Localizable(Events()) {
  ...
  constructor() {
    ...
    if (DomHelper.themeLoaded) {
      ...
      if (themeLink !== null && themeLink !== undefined && themeLink.sheet || !themeLink) {
        this.setup();
      }
...
You can access the API documentation at ${bryntumUrl}/products/${me.product.name}/docs`, 'font-family: system-ui; font-size: 1.3em; font-weight: bold; line-height: 2; background-repeat: no-repeat; background-position: left center; padding-inline-start: 2.1em; background-image: url("data:image/svg+xml;utf8,<svg width=\'20\' height=\'20\' viewBox=\'0 0 354.9 144.52\' xmlns=\'http://www.w3.org/2000/svg\'><path fill=\'white\' d=\'m305.63 144.52c-12.47 0-23.53-4.83-31.58-13.28v11.06h-25.54v-142.3h26.75v48.58c7.84-7.64 18.5-12.07 30.37-12.07 27.15 0 49.28 23.33 49.28 54.1s-22.12 53.9-49.28 53.9zm-3.82-83.47c-14.68 0-26.55 13.27-26.55 29.77s11.87 29.16 26.55 29.16 26.55-12.67 26.55-29.16-11.87-29.77-26.55-29.77z\'/><path fill=\'white\' d=\'m148.02 0h74.01v29.78h-74.01z\'/><path fill=\'white\' d=\'m0 56.26h222.03v29.78h-222.03z\'/><path fill=\'white\' d=\'m74.01 112.52h148.02v29.6h-148.02z\'/></svg>"), url("data:image/svg+xml;utf8,<svg width=\'23\' height=\'23\' xmlns=\'http://www.w3.org/2000/svg\'><rect fill=\'%230076f8\' rx=\'5\' ry=\'5\' x=\'0\' y=\'0\' width=\'100%\' height=\'100%\'></rect></svg>");', 'font-family: system-ui', 'line-height: 2; font-family: courier; color: light-dark(orangered, orange)', 'font-family: system-ui', 'line-height: 2; font-family: courier; color: light-dark(orangered, orange)', 'font-family: system-ui', 'line-height: 2; font-family: courier; color: light-dark(orangered, orange)', 'font-family: system-ui', 'line-height: 2; font-family: courier; color: light-dark(orangered, orange)', 'font-family: system-ui; line-height: 2;');
  ...
  insertHeader() {
    ...
    (_document$querySelect = document.querySelector('header.demo-header')) === null || _document$querySelect === undefined || _document$querySelect.remove();
    const logoSvg = `<svg viewBox="0 0 354.9 144.52" xmlns="http://www.w3.org/2000/svg">
      ...
      header = DomHelper.insertFirst(document.getElementById('container'), {
        ...
        html: isDemoBrowser ? `
            ...
            ` : `
                <a href="#start-of-content" id="skip-to-content" aria-labelledby="example-description">Skip to content</a>
                <a id="title" class="title" href="../${isUmd ? 'index.umd.html' : ''}${this.rtl ? '?rtl' : ''}#example-${exampleId}">
                    <h1>
                        ${logoSvg}
    ...
    (_document$getElementB = document.getElementById('skip-to-content')) === null || _document$getElementB === undefined || _document$getElementB.addEventListener('click', () => {
      ...
      focusTarget === null || focusTarget === undefined || focusTarget.focus();
    });
    me.header = header;
    if (isDemoBrowser) {
      ...
      me.productSelector = new Button({
        ...
        menu: {
          items: [{
            text: 'Bryntum Grid',
            href: `${bryntumUrl}/products/grid/examples/`
          }, {
            text: 'Bryntum Scheduler',
            href: `${bryntumUrl}/products/scheduler/examples/`
          }, {
            text: 'Bryntum Scheduler Pro',
            href: `${bryntumUrl}/products/schedulerpro/examples/`
          }, {
            text: 'Bryntum Gantt',
            href: `${bryntumUrl}/products/gantt/examples/`
          }, {
            text: 'Bryntum Calendar',
            href: `${bryntumUrl}/products/calendar/examples/`
          }, {
            text: 'Bryntum Task Board',
            href: `${bryntumUrl}/products/taskboard/examples/`
          }, {
            text: 'All products',
    ...
    const toolsContainer = new Toolbar({
      appendTo: header,
      cls: 'tools-container',
      ...
      }, 
      {
        ...
        async onClick({
          ...
          var _codeEditor, _codeEditor2, _pathName$match;
          const {
              element
            } = me,
            {
          ...
          const loadedCode = ((_codeEditor = codeEditor) === null || _codeEditor === undefined ? undefined : _codeEditor.codeCache['app.js']) || ((_codeEditor2 = codeEditor) === null || _codeEditor2 === undefined ? undefined : _codeEditor2.codeCache['app.module.js']),
            ...
            demoStyles = (me.appConfig.source ?? []).filter(file => file.endsWith('.css')).map(file => `<link rel="stylesheet" href="${productUrl}/examples/${demoName.toLowerCase()}/${file}?${hash}">`),
            formConfig = {
              tag: 'form',
              style: 'display:none',
  ...
  loadDescription() {
    ...
    ...(!themes[theme] || body.matches('.b-theme-custom') ? [] : [themeCombo = {
      ...
      colors: [['#e53935', 'Red'], ['#d81b60', 'Pink'], ['#c200c2', 'Magenta'], ['#8e24aa', 'Purple'], ['#5e35b1', 'Violet'], ['#4527a0', 'Deep-purple'], ['#3949ab', 'Indigo'], ['#1e88e5', 'Blue'], ['#03a9f4', 'Light-blue'], ['#3bc9db', 'Cyan'], ['#00897b', 'Teal'], ['#43a047', 'Green'], ['#8bc34a', 'Light-green'], ['#c0ca33', 'Lime'], ['#fdd835', 'Yellow'], ['#ffb300', 'Amber'], ['#fb8c00', 'Orange'], ['#f4511e', 'Deep-orange'], ['#757575', 'Gray'], ['#000000', 'Black']],
      onChange({
        value
      }) {
        document.documentElement.style.setProperty('--b-primary', value);
        GlobalEvents.trigger('primaryColorChange', {
          primaryColor: value
        });
  ...
  fireMouseEvent(type, target, offset = [0, 0], showCursor = false) {
    ...
    if (showCursor) {
      ...
      var _me$cursorElement;
      (_me$cursorElement = me.cursorElement) === null || _me$cursorElement === undefined || _me$cursorElement.remove();
    }
