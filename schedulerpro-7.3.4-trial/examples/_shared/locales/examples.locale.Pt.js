...
const locale = {
    ...
    Checkbox : {
        Cultural                : 'Cultural',
        'Draw around parents'   : 'Desenhar em torno dos pais',
    ...
    Tooltip : {
        ...
        'Disable tree group feature and back to default Resource - Assignment look'                                : 'Desativar a funcionalidade de agrupamento em árvore e voltar para a visualização padrão de Recurso - Atribuição',
        ...
        'Enter number of resource rows to generate and press [ENTER]'                                              : 'Digite o número de linhas de recurso para gerar e pressione [ENTER]',
    ...
    SlideToggle : {
        ...
        'Constrain drag to row'        : 'Restringir arrastar para a linha',
