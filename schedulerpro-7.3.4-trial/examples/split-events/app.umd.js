...
const scheduler = new SchedulerPro({
    ...
    eventRenderer({
        ...
        return StringHelper.encodeHtml(eventRecord.name || ((_eventRecord$event = eventRecord.event) === null || _eventRecord$event === undefined ? undefined : _eventRecord$event.name));
    },
    tbar : [{
        type    : 'slidetoggle',
