import { CalendarModel, Column, DateHelper, Grid, Model, ResourceModel, SchedulerPro, StringHelper, Toast, ViewPreset, ViewPresetConfig, Widget } from '@bryntum/schedulerpro';
    ...
    tbar : [
        ...
        },
        {
            ...
            onSelect({ record, source }) {
                ...
                scheduler.viewPreset = preset.preset as ViewPreset;
