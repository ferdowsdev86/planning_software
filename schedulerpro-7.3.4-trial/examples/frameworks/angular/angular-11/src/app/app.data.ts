export const projectData = {
    resources : [
        { id : 1, name : 'Truck 1', iconCls : 'fa fa-truck', image : false },
        { id : 2, name : 'Truck 2', iconCls : 'fa fa-truck', image : false },
        { id : 3, name : 'Truck 3', iconCls : 'fa fa-truck', image : false },
        { id : 4, name : 'Train 1', iconCls : 'fa fa-train', image : false },
        { id : 5, name : 'Train 2', iconCls : 'fa fa-train', image : false },
        { id : 6, name : 'Pickup 1', iconCls : 'fa fa-truck-pickup', image : false },
        { id : 7, name : 'Pickup 2', iconCls : 'fa fa-truck-pickup', image : false },
        { id : 8, name : 'Pickup 3', iconCls : 'fa fa-truck-pickup', image : false },
        { id : 9, name : 'Plane 1', iconCls : 'fa fa-plane', image : false },
        { id : 10, name : 'Plane 2', iconCls : 'fa fa-plane', image : false },
        { id : 11, name : 'Helicopter 1', iconCls : 'fa fa-helicopter', image : false },
        { id : 12, name : 'Rocket 1', iconCls : 'fa fa-rocket', image : false },
        { id : 13, name : 'Rocket 2', iconCls : 'fa fa-rocket', image : false },
        { id : 14, name : 'Horse', iconCls : 'fa fa-horse', image : false }
    ],
