import { Combo, type ComboConfig, ComboModel, type DomConfig, type Store } from '@bryntum/schedulerpro';
...
export default class VehicleConditionCombo extends Combo {
    ...
    static get configurable() {
        return {
            ...
            listItemTpl : record => {
                ...
                return `
                <div>
                    <i style="margin-inline-end: 0.5em" class="fa fa-car ${row.text.toLowerCase()}"></i>
    ...
    syncInputFieldValue(skipHighlight : boolean) {
        const
