import { EventStore, StringHelper, type FieldTriggerConfig } from '@bryntum/schedulerpro';
import { type BryntumGridProps, type BryntumSchedulerProProps } from '@bryntum/schedulerpro-vue-3';
...
export const schedulerProProps: BryntumSchedulerProProps = {
    ...
    eventRenderer({ eventRecord, renderData }) {
        ...
        renderData.style = `background-color: ${eventRecord.eventColor || eventRecord.resource.eventColor}`;
    ...
    columns : [
        {
            ...
            renderer   : ({ value }: { value: string }) => `<i class="fa fa-fw fa-grip"></i>${StringHelper.encodeHtml(value) || ''}`
        },
        {
            text     : 'Location',
