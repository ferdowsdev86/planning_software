import {
    DomHelper, StringHelper, DragHelper, DateHelper, ScrollManager, SchedulerPro, Grid, Store, CalendarModel,
...
export class Drag extends DragHelper {
            ...
            <div class="b-sch-event b-has-content b-sch-event-with-icon">
                <div class="b-sch-event-content">
                    ...
                    <div>
                        ...
                        <div class="b-patient">Patient: ${appointment.patient || ''}</div>
                    </div>
                </div>
            </div>
        `;
    ...
    override onDrag = ({ event, context }: { event: any, context: any }): void => {
        const
            ...
            doctor                          = context.target && schedule.resolveResourceRecord(context.target, [event.offsetX, event.offsetY]) as Doctor,
        ...
        context.valid = Boolean(newStartDate &&
            ...
            (schedule.allowOverlap || schedule.isDateRangeAvailable(newStartDate, lastAppointmentEndDate, null, doctor) &&
                ...
                (!calendar || (calendar as CalendarModel).isWorkingTime(newStartDate, lastAppointmentEndDate))));
