...
[ProjectModel](https://bryntum.com/products/scheudlerpro/docs/api/SchedulerPRo/model/ProjectModel).
...
[guide](https://bryntum.com/products/schedulerpro/docs/guide/Scheduler/data/crud_manager).
...
static get additionalFields() {
    return [
      ...
      { name : 'iconCls', dataSource : 'IconCls', defaultValue : 'fa fa-asterisk'}
    ];
  }
```
