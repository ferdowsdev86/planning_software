...
/**
 * This class interacts between SchedulerPro's ProjectModel and the SharePoint Task List by using a list proxy. It
...
export default class BaseService {
    ...
    /**
     * Returns the reference to the SchedulerPro view
     * https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/view/SchedulerPro
     */
    get schedulerPro() {
        return this.schedulerProRef.current.instance;
    }
        ...
        if (id && id !== this._listId) {
            ...
            if (this.schedulerPro) {
                this.model.load().then(() => {
                    ...
                    const { eventStore } = this.schedulerPro.project;
                    if (!eventStore.count) {
                        eventStore.add([
                            {
                                "Id"           : 1,
                                ...
                                "Duration"     : 4,
                                "DurationUnit" : "h",
                                "IconCls"      : "fa fa-fw fa-beer"
                            },
                            {
                                "Id"           : 2,
                                "Title"         : "Medium fun task",
                                "Duration"     : 8,
                                "DurationUnit" : "h",
                            ...
                            {
                                "Id"           : 6,
                                "Title"         : "Answer forum question",
                                "Duration"     : 4,
                                "DurationUnit" : "h",
                                "IconCls"      : "fa fa-fw fa-life-ring"
                            },
                            {
                                "Id"           : 7,
                                "Title"         : "Gym",
                            ...
                            },
                            {
                                ...
                                "Duration"     : 3,
                                "DurationUnit" : "h",
                                "IconCls"      : "fa fa-fw fa-phone"
                            },
                            {
                                "Id"           : 11,
                                "Title"         : "Angular bug fix",
                                "Duration"     : 3,
                                "DurationUnit" : "h",
    ...
    // Set the timespan on the SchedulerPro view
    public setTimeSpan(startDate, range) {
        const schedulerPro = this.schedulerPro;
        this.range = range;
        if (schedulerPro) {
            schedulerPro.setTimeSpan(startDate, DateHelper.add(startDate, range, 'month'));
        }
    }
