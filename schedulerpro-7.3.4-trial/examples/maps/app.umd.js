    ...
    listeners : {
        eventClick : ({
            ...
            if (eventRecord.marker) {
                var _mapPanel;
                (_mapPanel = mapPanel) === null || _mapPanel === undefined || _mapPanel.showTooltip(eventRecord, true);
            }
        },
        afterEventSave : ({
            eventRecord
            ...
            if (eventRecord.marker) {
                var _mapPanel2;
                (_mapPanel2 = mapPanel) === null || _mapPanel2 === undefined || _mapPanel2.scrollMarkerIntoView(eventRecord);
            }
        },
        unscheduledToggle({
            value
...
const unplannedGrid = new UnplannedGrid({
    ...
    listeners : {
        cellClick : ({
            ...
            if (record.marker) {
                var _mapPanel3;
                (_mapPanel3 = mapPanel) === null || _mapPanel3 === undefined || _mapPanel3.showTooltip(record, true);
            }
        }
    }
});
