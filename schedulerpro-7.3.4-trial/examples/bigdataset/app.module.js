...
import { DateHelper, AsyncHelper, DataGenerator, Mask, SchedulerPro } from '../../build/schedulerpro.module.js';
...
const
    ...
    scheduler          = new SchedulerPro({
        ...
        columns             : [
            ...
            { text : 'First name', field : 'firstName', width : 130 },
            { text : 'Surname', field : 'surName', width : 130 },
