    ...
    static configurable = {
        ...
        features         : {
            ...
            nestedEvents : {
                ...
                // Add "Group selected events" context menu item
                showCreateGroupMenuItem : true
            },
            dependencies : false
        },
...
class SubtaskTab extends EditorTab {
    ...
    findEarliestUnallocatedTimeSlot(parentEvent) {
        const subEvents = parentEvent.children.slice(),
            {
                endDate: parentEnd
            } = parentEvent;
        let {
        ...
        for (const nestedEvent of subEvents) {
            ...
            if (nestedStartDate.getTime() === startDate.getTime() || nestedStartDate < startDate && nestedEndDate > startDate) {
...
function createScheduler(mode) {
    ...
    (_scheduler = scheduler) === null || _scheduler === undefined || (_scheduler$destroy = _scheduler.destroy) === null || _scheduler$destroy === undefined || _scheduler$destroy.call(_scheduler);
