...
class Appointment extends EventModel {
    static fields = ['patient', 'requiredRole',
...
class Doctor extends ResourceModel {
    static fields = ['role', 'roleIconCls'];
}
...
class Drag extends DragHelper {
        ...
        proxy.innerHTML = StringHelper.xss`
            <div class="b-sch-event b-has-content b-sch-event-with-icon">
                <div class="b-sch-event-content">
                    <i class="fa ${draggedAppointment.iconCls}"></i>
                    <div>
    ...
    onDrag({
        ...
        const {
            ...
            newStartDate = schedule.getDateFromCoordinate(coordinate, 'round', false, true),
            ...
            calendar = doctor === null || doctor === undefined ? undefined : doctor.effectiveCalendar;
        ...
        // Require a resource with matching role
            !requiredRole || (doctor === null || doctor === undefined ? undefined : doctor.role) === requiredRole) && (
...
class Schedule extends SchedulerPro {
    ...
    static configurable = {
        ...
        columns             : [{
            ...
            renderer   : ({
                ...
                const ranges = (_record$calendar = record.calendar) === null || _record$calendar === undefined || (_record$calendar$getW = _record$calendar.getWorkingTimeRanges) === null || _record$calendar$getW === undefined ? undefined : _record$calendar$getW.call(_record$calendar, scheduler.startDate, scheduler.endDate);
                if (ranges !== null && ranges !== undefined && ranges.length) {
    ...
    onModeSwitchButton({
        ...
        this.trigger('modeSwitch', {
            modeConfig : button.schedulerConfig
        });
    }
    onSave() {
        ...
        columns : [{
            ...
            template : ({
                record: appointment
                        ...
                        <i class="fa fa-${appointment.iconCls || 'question'}"></i>
            ...
            renderer : ({
                record
            }) => `${record.duration ?? 0} ${record.durationUnit}`
        }],
        tbar : [{
            type : 'widget',
            tag  : 'strong',
...
let schedule = new Schedule({
    ...
    onModeSwitch({
        ...
        // Provide drag helper and unplanned-grid a reference to the new instance / project
        schedule = drag.schedule = new Schedule(newConfig);
        unplannedGrid.project = schedule.project;
    },
    onSelectionChange() {
        const {
                selectedRecords
