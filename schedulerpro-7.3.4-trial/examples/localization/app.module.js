...
import { SchedulerPro, LocaleManager, Localizable, StringHelper } from '../../build/schedulerpro.module.js';
...
new SchedulerPro({
    ...
    eventRenderer({ resourceRecord, renderData, eventRecord }) {
        renderData.iconCls = resourceRecord.company.startsWith('Big') ? 'fa fa-fish' : 'fa fa-rocket';
