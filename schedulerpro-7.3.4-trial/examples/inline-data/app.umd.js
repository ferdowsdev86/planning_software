...
class VehicleConditionColumn extends Column {
    ...
    renderer({
        ...
        const {
            ...
            condition = (_store$getById = store.getById(value)) === null || _store$getById === undefined ? undefined : _store$getById.text;
        return condition ? [{
            tag       : 'i',
...
class VehicleConditionCombo extends Combo {
    ...
    syncInputFieldValue(...args) {
        ...
        const condition = (_this$store$getById = this.store.getById(this.value)) === null || _this$store$getById === undefined ? undefined : _this$store$getById.text;
        this.icon.className = `fa fa-car ${condition === null || condition === undefined ? undefined : condition.toLowerCase()}`;
