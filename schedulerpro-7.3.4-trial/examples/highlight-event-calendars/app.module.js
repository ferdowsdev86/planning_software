...
import { Panel, EventModel, DateHelper, StringHelper, Container } from '../../build/schedulerpro.module.js';
    ...
    items    : {
        ...
        scheduler : {
            ...
            features : {
                ...
                eventTooltip : {
                    ...
                    template : ({ eventRecord }) => `<dl>
                        ...
                        <dt>Schedule info:</dt>
                        <dd>
                            <i class="fa fa-calendar-alt"></i>${StringHelper.encodeHtml(eventRecord.calendarInfo)}
                        </dd>` : ''}
                    </dl>`
                },
                taskEdit : {
            ...
            getDateConstraints(resourceRecord, eventRecord) {
                const timeRanges = eventRecord?.calendar?.getWorkingTimeRanges(this.startDate, this.endDate);
