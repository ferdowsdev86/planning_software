...
import { DateHelper, DragHelper, DomHelper, Toast, Tooltip, Combo, Scheduler, SchedulerEventModel, TreeGrid, Splitter } from '../../build/schedulerpro.module.js';
//region "lib/Drag.js"
...
class Drag extends DragHelper {
    ...
    onAbort({ context }) {
        if (context.resource) {
            this.schedule.getRowFor(context.resource)?.removeCls('target-resource');
        }
