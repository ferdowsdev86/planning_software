...
import { DomHelper, StringHelper, Scheduler } from '../../build/schedulerpro.module.js';
        ...
        },
        {
            ...
            menu : {
                ...
                items : {
                    ...
                    hideDelay : {
                        type  : 'slider',
                        min   : 300, // Min 300 when animating terminals, otherwise they will hide before animation finishes
                        max   : 600,
                        step  : 100,
                        unit  : 'ms',
