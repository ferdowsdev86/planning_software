...
import { Scheduler, AvatarRendering, SchedulerEventModel, SchedulerResourceModel } from '../../build/schedulerpro.module.js';
...
const scheduler = new Scheduler({
    ...
    features : {
        eventMenu : {
            ...
            clickTriggerSelector : '.b-sch-event .fa-ellipsis'
        },
        eventEdit : {
            items : {
                typeField : {
        ...
        // Event contents fills the entire event bar, which leaves nothing to stick
        stickyEvents : false
    },
