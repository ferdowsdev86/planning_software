...
import { DateHelper, SchedulerEventModel, Scheduler, PresetManager } from '../../build/schedulerpro.module.js';
...
const scheduler = new Scheduler({
    ...
    listeners : {
        zoomLevelChange({ zoomLevel }) {
            const
                me = this,
                { zoomInButton, zoomOutButton } = me.widgetMap;
    ...
    tbar : [
        ...
        },
        {
            ...
            rendition : 'text',
            onClick() {
                scheduler.zoomOut({ animate : true });
            }
        }
    ]
});
