...
import { DragHelper, Toast, List, Scheduler, DateHelper, StringHelper, SchedulerEventModel, AjaxStore, Panel } from '../../build/schedulerpro.module.js';
//region "lib/Drag.js"
...
class EquipmentList extends List {
    ...
    static configurable = {
        itemTpl : record => `<i class="b-equipment-icon ${record.iconCls} b-colorize"></i>${record.name}`
    };
}
