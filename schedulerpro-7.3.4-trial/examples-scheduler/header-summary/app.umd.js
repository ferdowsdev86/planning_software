                ...
                headerRenderer() {
                    return titles.map(title => `
                        <div class="b-column-header-row">
                            <i class="fa ${groupIcons[title === null || title === undefined ? undefined : title.toLowerCase()]}"></i>${title}
                        </div>`).join('');
                },
                filterable : {
                    filterField : {
                ...
                group     : {
                    renderer({
                        ...
                        if (rowElement.closest('[data-region="locked"]')) {
                            return `<i class="fa ${groupIcons[groupRowFor === null || groupRowFor === undefined ? undefined : groupRowFor.toLowerCase()]}"></i><span class="b-group-header-row-text">${groupRowFor}</span>`;
                        }
                    }
                }
            },
