...
Ext.define('Bryntum.SchedulerPanel', {
    ...
    config : {
        ...
        /**
         * The {@link Scheduler.data.SchedulerEventStore} holding the events to be rendered into the scheduler (required)
         * @type {Scheduler.data.SchedulerEventStore}
         * @config
         */
        eventStore : null,

        /**
         * The {@link Scheduler.data.SchedulerResourceStore} holding the resources to be rendered into the scheduler (required)
         * @type {Scheduler.data.SchedulerResourceStore}}
         * @config
         */
        resourceStore : null,
    ...
    applyScheduler : function(scheduler) {
        ...
        scheduler = new bryntum.schedulerpro.Scheduler(scheduler);
    ...
    statics : {
        createPropertyProxy : function(proto, name) {
            const
                capName  = Ext.String.capitalize(name),
                propName = '_' + name;
    ...
    const
        proto              = SchedulerPanel.prototype,
