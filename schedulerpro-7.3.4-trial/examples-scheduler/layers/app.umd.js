        ...
        right : {
            ...
            items : {
                list : {
                    ...
                    items       : [{
                        id       : 1,
                        text     : 'Time range lines',
                        selector : '.b-sch-time-ranges-canvas .b-sch-line'
                    }, {
                        id       : 2,
                        text     : 'Task bars',
                        ...
                        selector : '.b-resource-time-range-canvas'
                    }, {
                        id       : 5,
                        text     : 'Time ranges',
                        selector : '.b-sch-time-ranges-canvas .b-sch-time-range:not(.b-sch-line)'
                    }, {
                        id       : 6,
                        text     : 'Row elements',
                        selector : '.b-time-axis-sub-grid .b-grid-row'
                    }, {
                        id       : 7,
                        text     : 'Nonworking time',
                        selector : '.b-sch-non-working-time'
                    }, {
                        id       : 8,
