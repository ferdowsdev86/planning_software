...
const {
    ...
    resourceComboConfig = {
    // Will resolve on owning Widget which implements this; The Scheduler
...
const scheduler = new Scheduler({
    ...
    features              : {
        ...
        eventEdit  : {
            ...
            items : {
                ...
                // Set up dynamic toggling of fields per eventType
                eventTypeField : {
                    type    : 'radiogroup',
                    name    : 'eventType',
                    label   : 'Type',
                ...
                linkField : {
                    ...
                    name     : 'id',
                    weight   : 600,
                    template : link => xss`<a href='//your.app/task/${link}' target='blank'>Open in new tab</a></div>`
                }
            }
        }
    },
    ...
    listeners : {
        ...
        selectionChange({
            ...
            if (mode === 'row' && selected !== null && selected !== undefined && selected.length) {
        ...
        items : {
            ...
            dateField : {
                ...
                listeners  : {
                    change : ({
                        value
                    }) => scheduler.setTimeSpan(DateHelper.add(value, 8, 'hour'), DateHelper.add(value, 22, 'hour'))
                }
            }
        }
    },
