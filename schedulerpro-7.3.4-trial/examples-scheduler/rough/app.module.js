...
import { Scheduler, DomHelper } from '../../build/schedulerpro.module.js';
...
const resources = [
    ...
    events    = [
        ...
        },
        {
            ...
            name       : 'Default with purple color',
            eventColor : 'purple'
        },
        {
            id          : 'e4',
        ...
        },
        {
            ...
            name        : 'Cross-hatched orange fill',
            roughConfig : {
                fill      : 'orange',
...
const scheduler = new Scheduler({
    ...
    listeners : {
        // Triggered when an event/task is rendered and its element is available. Since scheduler renders what is in view
        ...
        renderEvent({ source : scheduler, eventRecord, resourceRecord, renderData, element }) {
            // Use Rough.js (https://github.com/pshihn/rough) to draw events with a sketched look
            ...
            if (!canvas) {
                ...
                roughCanvas = roughData.roughCanvas = window.rough.canvas(canvas);
