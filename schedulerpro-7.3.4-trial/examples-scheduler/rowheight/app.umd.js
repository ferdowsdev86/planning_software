            ...
            items         : {
                ...
                resourceMarginTop : {
                    ...
                    onInput({
                        ...
                        var _adjustTarget$resourc;
                        scheduler.suspendAnimations();
                        adjustTarget.resourceMargin = {
                            start : value,
                            end   : ((_adjustTarget$resourc = adjustTarget.resourceMargin) === null || _adjustTarget$resourc === undefined ? undefined : _adjustTarget$resourc.end) ?? scheduler.resourceMargin.end
                        };
                        changeAdjustTarget(adjustTarget);
                        scheduler.resumeAnimations();
                    }
                ...
                resourceMarginBottom : {
                    ...
                    onInput({
                        ...
                        var _adjustTarget$resourc2;
                        scheduler.suspendAnimations();
                        adjustTarget.resourceMargin = {
                            end   : value,
                            start : ((_adjustTarget$resourc2 = adjustTarget.resourceMargin) === null || _adjustTarget$resourc2 === undefined ? undefined : _adjustTarget$resourc2.start) ?? scheduler.resourceMargin.start
                        };
                        changeAdjustTarget(adjustTarget);
                        scheduler.resumeAnimations();
                    }
...
scheduler.crudManager.on('load', () => {
    ...
    resource.items = [{
        id   : 'all',
        name : 'All unset'
    }].concat(scheduler.resourceStore.records.map(r => ({
        id   : r.id,
        name : r.name
    })));
});