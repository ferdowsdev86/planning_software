...
import { DateHelper, DragHelper, DomHelper, Toast, Tooltip, Scheduler, SchedulerEventModel, Grid, StringHelper, Splitter } from '../../build/schedulerpro.module.js';
//region "lib/Drag.js"
...
class Drag extends DragHelper {
    ...
    createProxy(element) {
        ...
        // Fake an event bar
        proxy.classList.add('b-sch-event-wrap', 'b-style-indented', 'b-unassigned-class', 'b-colorize', `b-sch-${schedule.mode}`);
