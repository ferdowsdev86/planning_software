...
import { Column, ColumnStore, Combo, Scheduler, StringHelper } from '../../build/schedulerpro.module.js';
    ...
    columns : [
        {
            ...
            region     : 'left',
            htmlEncode : false,
            renderer   : ({ value, record }) => StringHelper.xss`<div class="box b-color-${record.color}"></div>${value}`
        },
        { text : 'Floor', field : 'floor', width : 100, region : 'left' },
        {
            ...
            renderer({ value }) {
                ...
                return StringHelper.xss`${value}<div class="capacity fa fa-fw fa-${icon}"></div>`;
            }
        },
        { type : 'roomthemecolumn', region : 'left', minWidth : '14em' },
        { text : 'Redecorated', field : 'redecorated', width : 120, region : 'right', type : 'date' },
