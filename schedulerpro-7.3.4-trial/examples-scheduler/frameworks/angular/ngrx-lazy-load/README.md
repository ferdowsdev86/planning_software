# Lazy loading with NgRx (Angular)

This example uses Bryntum Scheduler Pro wrapped in the provided BryntumSchedulerProComponent wrapper.
Resources and events are lazily loaded on demand via NgRx (Store + Effects), so the scheduler scrolls on both axes.

This application was generated with:

* [Angular](https://angular.io/) [20.3.18]
