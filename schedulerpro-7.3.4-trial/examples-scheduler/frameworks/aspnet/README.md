...
check [Online npm repository guide](https://bryntum.com/products/scheduler/docs/guide/Scheduler/npm-repository) for detailed information
...
2) Build the solution, it will resolve dependencies.
