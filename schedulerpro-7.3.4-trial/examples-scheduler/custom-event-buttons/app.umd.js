...
class CustomResourceModel extends SchedulerResourceModel {
    ...
    get imageUrl() {
        return `../_shared/images/transparent-users/${this.name.toLowerCase()}.png`;
    }
}
const resources = [{
    id   : 1,
...
const scheduler = new Scheduler({
    ...
    eventRenderer({
        ...
        return [{
            ...
            class    : 'footer',
            children : [eventRecord.label ? {
                tag   : 'span',
                class : 'label b-bryntum',
                text  : eventRecord.label
            } : null, eventRecord.label2 ? {
                tag   : 'span',
                class : 'label2 b-bryntum',
    ...
    onEventClick({
        ...
        switch (true) {
            ...
            case target.matches('.fa-chevron-right'):
                eventRecord.shift((target.className.match('left') ? -1 : 1) * 30, 'min');
                break;
            case target.matches('.fa-link'):
                MessageDialog.alert({
    ...
    onTimelineContextChange({
        ...
        (_document$querySelect = document.querySelector(`.b-sch-header-time-axis-cell.highlight`)) === null || _document$querySelect === undefined || _document$querySelect.classList.remove('highlight');
        if (context) {
            ...
            (_document$querySelect2 = document.querySelector(`.b-sch-header-time-axis-cell[data-tick-index="${tick}"]`)) === null || _document$querySelect2 === undefined || _document$querySelect2.classList.add('highlight');
        }
    }
});