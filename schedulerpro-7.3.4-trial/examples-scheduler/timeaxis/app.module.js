...
import { Scheduler, DateHelper, TabPanel } from '../../build/schedulerpro.module.js';
//region "lib/SchedulerCompressedTimeAxis.js"
...
class SchedulerCompressedTimeAxis extends Scheduler {
    ...
    static type = 'schedulercompressedtimeaxis';
...
//region "lib/SchedulerCustomTimeAxis.js"

class SchedulerCustomTimeAxis extends Scheduler {
    // Factoryable type name
    static type = 'schedulercustomtimeaxis';
...
//region "lib/SchedulerCustomTimeAxis2.js"

class SchedulerCustomTimeAxis2 extends Scheduler {
    // Factoryable type name
    static type = 'schedulercustomtimeaxis2';
...
//region "lib/SchedulerCustomTimeAxis3.js"

class SchedulerCustomTimeAxis3 extends Scheduler {
    // Factoryable type name
    static type = 'schedulercustomtimeaxis3';
...
//region "lib/SchedulerFilterableTimeAxis.js"

class SchedulerFilterableTimeAxis extends Scheduler {
    // Factoryable type name
    static type = 'schedulerfilterabletimeaxis';
            ...
            viewPreset : {
                ...
                headers : [
                    ...
                    },
                    {
                        unit  : 'DAY',
                        align : 'center',
                        renderer(start, end, config, index, scheduler) {
                            return scheduler.eventStore.getEvents({
                                startDate : start,
                                endDate   : end
                            }).length;
                        }
...
//region "lib/SchedulerTertialTimeAxis.js"

class SchedulerTertialTimeAxis extends Scheduler {
    // Factoryable type name
...
const tabPanel = new TabPanel({
    ...
    items     : {
        ...
        tertial : {
            title      : 'Tertial time axis',
            type       : 'schedulertertial',
            // Enables smoother wheel and pinch zooming
            smoothZoom : true,
            startDate  : new Date(2023, 0, 1),
            endDate    : new Date(2025, 1, 0)
        }
    }
});
