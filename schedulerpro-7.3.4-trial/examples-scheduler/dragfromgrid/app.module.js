...
import { DateHelper, DragHelper, DomHelper, Toast, Tooltip, Combo, Scheduler, SchedulerEventModel, SchedulerEventStore, Grid, StringHelper, Splitter } from '../../build/schedulerpro.module.js';
//region "lib/Drag.js"
...
class Drag extends DragHelper {
    ...
    onDrop({ context }) {
        const
            me                                         = this,
            { schedule }                               = me,
            { task, target, resource, valid, startDate } = context;
