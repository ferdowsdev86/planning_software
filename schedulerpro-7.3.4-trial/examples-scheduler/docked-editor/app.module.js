...
const
    resources = [
        ...
        { id : 'r2', name : 'Linda', eventColor : 'magenta' },
        { id : 'r3', name : 'Don', eventColor : 'purple' },
        { id : 'r4', name : 'Karen', eventColor : 'violet' },
        { id : 'r5', name : 'Doug', eventColor : 'indigo' },
        { id : 'r6', name : 'Peter', eventColor : 'blue' },
        { id : 'r7', name : 'Sam', eventColor : 'light-blue' },
        { id : 'r8', name : 'Melissa', eventColor : 'cyan' },
        { id : 'r9', name : 'John', eventColor : 'teal' },
        { id : 'r10', name : 'Ellen', eventColor : 'green' }
    ],
    events = [
        {
            id         : 1,
...
const scheduler = new Scheduler({
    ...
    barMargin  : 5,
    columns    : [
        { type : 'resourceInfo', width : 130, text : 'Name' }
    ],
    resourceImages : {
