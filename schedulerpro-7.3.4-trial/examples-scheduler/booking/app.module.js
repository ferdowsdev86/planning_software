...
import { DateHelper, ResourceTimeRangeStore, ResourceTimeRangeModel, InstancePlugin, GridFeatureManager, DomHelper, EventHelper, Tooltip, SchedulerResourceModel, SchedulerEventModel, StringHelper, LocaleManager, Scheduler } from '../../build/schedulerpro.module.js';
...
const scheduler = new Scheduler({
    ...
    columns : [
        {
            ...
            width           : 260,
            sum             : 'count',
            summaryRenderer : ({ sum }) => xss`Total properties: ${sum}`,
    ...
    listeners : {
        ...
        resourceTimeRangeDblClick({ resourceTimeRangeRecord, resourceRecord }) {
