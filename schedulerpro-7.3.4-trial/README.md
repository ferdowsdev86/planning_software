...
Bryntum Scheduler Pro is a full-featured resource scheduler supporting a wide range of functionality.
...
If you're using an AI assistant (Claude Code, Cursor, Codex, etc.):

* Read [`AGENTS.md`](./AGENTS.md) in this folder — it covers the version pitfalls and load-bearing setup rules.
* For up-to-date, grounded answers, point your assistant at the
  [Bryntum MCP server](https://bryntum.com/products/schedulerpro/docs/guide/SchedulerPro/ai-features/mcp-server?utm_source=ax-download).
* Install the [Bryntum agent skills](https://github.com/bryntum/skills) for one-shot setup in Claude Code, Cursor, or
  Codex.
