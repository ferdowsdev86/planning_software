...
```shell
yarn add @bryntum/grid@npm:@bryntum/grid-trial@7.3.4
yarn add @bryntum/grid-angular@7.3.4
```
...
[Framework wrappers](#Grid/guides/npm/repository/components.md#frameworks-wrappers) table.
...
[Project cleanup](#Grid/guides/npm/repository/troubleshooting.md#project-cleanup) guide.
...
```shell
npm install @bryntum/grid@6.1.8-nightly.20250330
```
...
1. Log in to the Bryntum npm repository using your licensed Customer Zone account as described in the
   [Login](#Grid/guides/npm/repository/private-repository-access.md#login) guide
...
3. Perform a project cleanup as described in the [Project cleanup](#Grid/guides/npm/repository/troubleshooting.md#project-cleanup)
   guide
