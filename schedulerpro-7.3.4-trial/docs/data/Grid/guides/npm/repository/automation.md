...
You may use [Access tokens](#Grid/guides/npm/repository/private-repository-access.md#access-tokens) stored in `.npmrc` in 
...
| Username       | Username for [Bryntum repository authentication](#Grid/guides/npm/repository/private-repository-access.md) |
| Password       | Password for [Bryntum repository authentication](#Grid/guides/npm/repository/private-repository-access.md) |
...
```json
"dependencies": {
  "@bryntum/grid-lib-trial": "file:./lib/bryntum-grid-lib-trial-1.0.1.tgz"  
  "@bryntum/grid": "file:./lib/bryntum-grid-trial-7.3.4.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/grid-lib": "file:./lib/bryntum-grid-lib-1.0.1.tgz"  
  "@bryntum/grid": "file:./lib/bryntum-grid-7.3.4.tgz"
}
```
</div>
</div>
