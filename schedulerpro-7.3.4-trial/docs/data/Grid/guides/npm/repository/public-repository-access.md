...
|-----------------------|---------------------------------|
| Angular (IVY)         | `@bryntum/grid-angular`      |
| Angular (View Engine) | `@bryntum/grid-angular-view` |
| Angular (Thin)        | `@bryntum/grid-angular-thin` |
| React                 | `@bryntum/grid-react`        |
| React (Thin)          | `@bryntum/grid-react-thin`   |
| Vue 2.x               | `@bryntum/grid-vue`          |
| Vue 3.x               | `@bryntum/grid-vue-3`        |
| Vue 3.x (Thin)        | `@bryntum/grid-vue-3-thin`   |
