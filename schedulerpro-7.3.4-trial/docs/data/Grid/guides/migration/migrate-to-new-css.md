...
2. Include the structural CSS file, e.g. `grid.css`<sup>*</sup>.
...
1. Rename any used Bryntum selectors to use kebab-case. For example (inconclusive list):
    ...
    <div class="note">
See the <a href="#Grid/guides/migration/migrate-to-new-css.md#renamed-selectors">Renamed selectors</a> section below for more information.
</div>
...
| .b-cellediteditor                        | .b-simple-event-editor                          |
