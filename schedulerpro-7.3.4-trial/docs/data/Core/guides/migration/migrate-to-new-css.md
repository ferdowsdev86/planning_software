...
2. Include the structural CSS file, e.g. `core.css`<sup>*</sup>.
...
<link rel="stylesheet" href="build/core.stockholm.css" data-bryntum-theme>
```
...
1. Rename any used Bryntum selectors to use kebab-case. For example (inconclusive list):
    ...
    <div class="note">
See the <a href="#Core/guides/migration/migrate-to-new-css.md#renamed-selectors">Renamed selectors</a> section below for more information.
</div>
