...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/core/-/core-7.3.4.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
...
npm ERR! 404
npm ERR! 404 '@bryntum/core@7.3.4' is not in the npm registry.
```
...
> YN0035: | @bryntum/core@npm:7.3.4: Package not found
...
[Configure npm](#Core/guides/npm/repository/private-repository-access.md#configure-npm) guide and reinstall the
package.
...
* Install a supported **npm** version as stated in
  [NPM requirements](#Core/guides/npm/repository/package-managers.md#npm-requirements)
* You cannot have access to full package `@bryntum/core` from a trial account. Use `@bryntum/core-trial`
  package as described in 
  [Installing trial packages](#Core/guides/npm/repository/installation.md#installing-trial-packages)
...
* If you use **yarn** please check 
  [Yarn package manager](#Core/guides/npm/repository/package-managers.md#yarn-package-manager) information
