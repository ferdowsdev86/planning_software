...
[Repository access](#Core/guides/npm/repository/private-repository-access.md) guide. This step is mandatory. 
...
You may also [create new token](#Core/guides/npm/repository/automation.md#creating-an-access-token).
