...
Do not mix regular (e.g., <code>@bryntum/core</code>) and thin (e.g., <code>@bryntum/core-thin</code>) packages in the same project.
If using thin packages, remove regular ones and follow this guide to install all
<a href="#Core/guides/integration/angular/multiple-products.md#package-dependencies">required dependencies</a>.
...
```json
"dependencies": {
  "@bryntum/core-thin": "npm:@bryntum/core-thin-trial@7.3.4",
}
```
