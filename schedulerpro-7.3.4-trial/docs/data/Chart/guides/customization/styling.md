# Styling
The Bryntum Chart is rendered in the DOM using regular HTML and CSS, and can be completely styled using CSS. It ships 
with both pre-compiled CSS bundles, and the original CSS files. The CSS includes different themes and colors, 
which can be used to alter how the Chart and its contents look.
...
The Chart ships with four themes, each available in light and dark variants:
...
```html
<!-- Structural CSS -->
<link rel="stylesheet" href="build/chart.css">
<!-- Bryntum theme -->
...
![Svalbard Light theme](Chart/themes/thumb.svalbard-light.png "Svalbard Light theme")
![Svalbard Dark theme](Chart/themes/thumb.svalbard-dark.png "Svalbard Dark theme")

#### Stockholm

The Stockholm theme was our default theme prior to v7.0. It has been updated with a more modern look and feel.

![Stockholm Light theme](Chart/themes/thumb.stockholm-light.png "Stockholm Light theme")
![Stockholm Dark theme](Chart/themes/thumb.stockholm-dark.png "Stockholm Dark theme")
...
![Visby Light theme](Chart/themes/thumb.visby-light.png "Visby Light theme")
![Visby Dark theme](Chart/themes/thumb.visby-dark.png "Visby Dark theme")
...
![Material3 Light theme](Chart/themes/thumb.material3-light.png "Material Light theme")
![Material3 Dark theme](Chart/themes/thumb.material3-dark.png "Material Dark theme")
...
![Fluent2 Light theme](Chart/themes/thumb.fluent2-light.png "Fluent2 Light theme")
![Fluent2 Dark theme](Chart/themes/thumb.fluent2-dark.png "Fluent2 Dark theme")
...
![Change theme](Chart/changing-theme.png "Change theme")

### Combining products

The structural CSS described above include all the CSS you need to use Chart and its helper widgets such as Popups,
...
product. These are called `thin` CSS bundles (e.g. `chart.thin.css`). 
...
To create your own theme, get the [distribution bundle](#Chart/guides/download.md) or install the NPM package as usual and follow these steps:
...
![Custom theme](Chart/themes/thumb.custom.png "Custom theme")
...
```javascript
import { Chart, DomHelper } from '@bryntum/chart';
...
`7.3.4` of Chart, you need to have the CSS files of version `7.3.4`.
...
(`chart.css?v=7.3.4`) or use timestamps (`chart.css?1704085200`).
