...
Bryntum Chart uses locales for translating texts, date formats and such to different languages. This guide shows you 
how to use the supported locales in Bryntum Chart and how to create your own.
...
Bryntum Chart ships with the following locales:
...
* `PATH_TO_BUILD` targets the **build** source folder of the distribution zip or the **node_modules/@bryntum/chart**
...
```javascript
import { LocaleManager, LocaleHelper } from 'PATH_TO_BUILD/chart.module.js';
```
...
```html
<script src="PATH_TO_BUILD/chart.umd.js"></script>
```

JavaScript:

```javascript
const { LocaleManager } = window.bryntum.chart;
```
...
Bryntum Chart ships with two locale management classes [LocaleHelper](#Core/localization/LocaleHelper) and
...
```javascript
import { LocaleHelper } from 'PATH_TO_BUILD/chart.module.js';
...
```javascript
import { LocaleManager } from 'PATH_TO_BUILD/chart.module.js';
...
```html
<script src="PATH_TO_BUILD/locales/chart.locale.SvSE.js"></script>
```
...
The default English (US) locale is part of the Bryntum Chart bundle, you don't need to include it separately.
...
```javascript
import 'PATH_TO_BUILD/locales/chart.locale.SvSE.js';
```

<div class="note">

The default English locale is part of the Bryntum Chart bundle, you don't need to import it separately.
...
import { LocaleManager, LocaleHelper } from 'PATH_TO_BUILD/chart.module.js';
// Import default locale SvSE first. This will also publish it
import SvSELocale from 'PATH_TO_BUILD/locales/chart.locale.SvSE.js';
...
The code below contains full localization for Bryntum Chart which can be used for creating new locales.
...
const locale = {
    ...
    AIBase : {
        ...
        updatingStatusText            : modelName => `Updating ${modelName}s`,
        removingStatusText            : modelName => `Removing ${modelName}s`,
        addingStatusText              : modelName => `Adding ${modelName}`,
        filteringStatusText           : modelName => `Filtering ${modelName}s`,
    ...
    DatePicker : {
        ...
        gotoNextMonth : 'Go to next month',
        gotoNextYear  : 'Go to next year',
        navigation    : 'Date picker navigation'
    },
    ...
    ChartDesigner : {
        ...
        subtitle             : 'Subtitle',
        legend               : 'Legend',
        labelsHorizontalAxis : 'Labels (Horizontal Axis)',
        series               : 'Series',
        categories           : 'Categories (Slice Labels)',
        ...
        subtitlePlaceholder  : 'Chart Subtitle'
    },
