...
Please visit [Download Free Trial](https://bryntum.com/download/?product=chart) page to request distribution zip with product
packages and demos for Bryntum Chart.

### Licensed distribution

Licensed distribution zip with product packages, sources and demos for Bryntum Chart can be downloaded from
[Bryntum Customer Zone](https://customerzone.bryntum.com/).

Bryntum Customer Zone contains nightly builds for Bryntum Chart with the latest changes.
...
The Bryntum Chart distribution provides pre-build JavaScript bundles.
...
| File                    | Contents                                                        |
|-------------------------|-----------------------------------------------------------------|
| `chart.module.js`     | Modules format bundle without WebComponents                     |
| `chart.lwc.module.js` | Modules format bundle with Lightning WebComponents (Salesforce) |
| `chart.wc.module.js`  | Modules format bundle with WebComponents                        |
| `chart.umd.js`        | UMD format bundle with WebComponents                            |
...
Distribution zip contains Bryntum Chart themes which can be found in **/build** folder

| File                              | Contents                      |
|-----------------------------------|-------------------------------|
| `chart.css`                     | Structural CSS                |
...
All vanilla JavaScript demos for Bryntum Chart are located in the **/examples** folder in the distribution zip.

We recommend unzipping the package and configuring your preferred webserver to serve the contents of the unzipped
folder. For example you may configure your webserver to serve the Bryntum Chart folder as 
`http://localhost`.
...
For example you may configure webserver to serve Bryntum Chart folder as `http://localhost`.
