...
Do not mix regular (e.g., <code>@bryntum/chart</code>) and thin (e.g., <code>@bryntum/chart-thin</code>) packages in the same project.
If using thin packages, remove regular ones and follow this guide to install all
<a href="#Chart/guides/integration/angular/multiple-products.md#package-dependencies">required dependencies</a>.
...
Example for `@bryntum/chart-thin-trial` package:

```shell
npm install @bryntum/chart-thin@npm:@bryntum/chart-thin-trial@7.3.4
```
...
```json
"dependencies": {
  "@bryntum/chart-thin": "npm:@bryntum/chart-thin-trial@7.3.4",
}
```
