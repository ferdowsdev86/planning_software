# Bryntum Chart events in Angular

The Bryntum Chart events are passed up to the Angular wrapper which makes it possible to listen to them the standard
Angular way.
...
[`listeners`](https://bryntum.com/products/chart/docs/api/Core/mixin/Events#config-listeners)
