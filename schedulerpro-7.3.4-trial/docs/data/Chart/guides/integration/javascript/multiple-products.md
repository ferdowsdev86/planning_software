...
<a href="#Chart/guides/integration/javascript/multiple-products.md#package-dependencies">required dependencies</a>.
...
import { Chart } from 'chart.module.thin.js';
...
const { Store, Grid, Chart } = window.bryntum.scheduler;
