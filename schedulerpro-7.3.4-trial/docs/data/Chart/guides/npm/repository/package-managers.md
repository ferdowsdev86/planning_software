...
Bryntum demo applications use package aliasing for trial Bryntum Chart packages. This requires **npm** versions that 
support aliases.
...
[Repository access](#Chart/guides/npm/repository/private-repository-access.md) guide. This step is mandatory. 
...
You may also [create new token](#Chart/guides/npm/repository/automation.md#creating-an-access-token).
