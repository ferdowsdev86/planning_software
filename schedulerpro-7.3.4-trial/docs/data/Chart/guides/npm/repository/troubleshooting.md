...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/chart/-/chart-7.3.4.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
npm error 403 "user..yourdomain.com" only has access for trial packages
npm error 403 It is not allowed to install licensed package "@bryntum/chart"
npm error 403 Use "@bryntum/chart-trial" package instead or contact support
npm error 403 --------------------------------------------------------
npm error 403   Npm server login guide: https://npm.bryntum.com/help
npm error 403   Get support at: https://forum.bryntum.com/
npm error 403 --------------------------------------------------------
...
[CustomerZone](https://customerzone.bryntum.com) account has no valid Bryntum Chart license.
...
```shell
Not Found - GET https://registry.npmjs.org/@bryntum%2fchart"
npm ERR! 404
npm ERR! 404 '@bryntum/chart@7.3.4' is not in the npm registry.
```
...
> YN0035: | @bryntum/chart@npm:7.3.4: Package not found
> YN0035: |   Response Code: 404 (Not Found)
> YN0035: |   Request Method: GET
> YN0035: |   Request URL: https://registry.yarnpkg.com/@bryntum%chart
...
[Configure npm](#Chart/guides/npm/repository/private-repository-access.md#configure-npm) guide and reinstall the
package.
...
* Install a supported **npm** version as stated in
  [NPM requirements](#Chart/guides/npm/repository/package-managers.md#npm-requirements)
* You cannot have access to full package `@bryntum/chart` from a trial account. Use `@bryntum/chart-trial`
  package as described in 
  [Installing trial packages](#Chart/guides/npm/repository/installation.md#installing-trial-packages)
...
* If you use **yarn** please check 
  [Yarn package manager](#Chart/guides/npm/repository/package-managers.md#yarn-package-manager) information
...
* Browse [Bryntum Chart examples](https://bryntum.com/products/chart/examples/)
...
* Read [Bryntum Chart Online Documentation](https://bryntum.com/products/chart/docs/)
