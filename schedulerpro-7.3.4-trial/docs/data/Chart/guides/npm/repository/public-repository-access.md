...
|-----------------------|---------------------------------|
| Angular (IVY)         | `@bryntum/chart-angular`      |
| Angular (View Engine) | `@bryntum/chart-angular-view` |
| Angular (Thin)        | `@bryntum/chart-angular-thin` |
| React                 | `@bryntum/chart-react`        |
| React (Thin)          | `@bryntum/chart-react-thin`   |
| Vue 2.x               | `@bryntum/chart-vue`          |
| Vue 3.x               | `@bryntum/chart-vue-3`        |
| Vue 3.x (Thin)        | `@bryntum/chart-vue-3-thin`   |
