...
You may use [Access tokens](#Chart/guides/npm/repository/private-repository-access.md#access-tokens) stored in `.npmrc` in 
...
| Username       | Username for [Bryntum repository authentication](#Chart/guides/npm/repository/private-repository-access.md) |
| Password       | Password for [Bryntum repository authentication](#Chart/guides/npm/repository/private-repository-access.md) |
...
After these actions you will be able to install `@bryntum\Chart` package with your Artifactory login from `.npmrc`
file.
...
```json
"dependencies": {
  "@bryntum/chart-lib-trial": "file:./lib/bryntum-chart-lib-trial-1.0.1.tgz"  
  "@bryntum/chart": "file:./lib/bryntum-chart-trial-7.3.4.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/chart-lib": "file:./lib/bryntum-chart-lib-1.0.1.tgz"  
  "@bryntum/chart": "file:./lib/bryntum-chart-7.3.4.tgz"
}
```
</div>
</div>
