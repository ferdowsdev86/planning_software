...
```text
The Chart is sized by its predefined minHeight, likely this is not intended.
...
This guide uses Chart in the snippets, but the same principles applies to Scheduler, Scheduler Pro, Gantt,
