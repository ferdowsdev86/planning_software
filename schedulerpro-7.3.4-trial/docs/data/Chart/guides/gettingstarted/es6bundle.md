...
Include CSS for the Chart, FontAwesome (used for the built-in icons) and the theme you want to use on page:
...
```javascript
import { Chart } from '../build/chart.module.js';
```
...
If you get a `The Bryntum Chart bundle was loaded multiple times by the application` error, it means that
...
1. Imports from different types of the bundle (e.g. *.module.js and *.umd.js)
   ...
   **Not ok**
   ...
   ```javascript
   // File src/A.js
   import { Button } from 'chart.module.js';
   // File src/B.js
   import { TextField } from 'chart.umd.js';
   ```
   ...
   **Ok**
   ...
   import { Button } from 'chart.module.js';
   // File src/B.js
   import { TextField } from 'chart.module.js';
   ```
...
2. Import do not use the shortest relative path to the bundle
   ...
   **Not ok**
   ...
   import { Button } from 'chart.module.js';
   // File src/B.js
   import { Button } from '../src/chart.module.js';
   ```
...
3. Imports missing file type, some web servers still serve files without file type (does not apply for some frameworks, 
   ...
   **Not ok**
   ...
   import { Button } from 'chart.module.js';
   // File src/B.js
   import { TextField } from 'chart.module';
   ```
...
4. Cache busters that differs between imports
   ...
   **Not ok**
   ...
   ```javascript
   // File src/A.js
   import { Button } from 'chart.module.js?6781';
   // File src/B.js
   import { Button } from 'chart.module.js?9463';
   ```
...
6. Importing multiple Bryntum products in the same application
   ...
   Regular (full) bundles include the entire dependency chain. For example, `chart.module.js` includes Chart
   ...
   **Ok** — using thin bundles:
   ...
   See the [Multiple products guide](#Chart/guides/integration/javascript/multiple-products.md) for full details and
   dependency tables.
