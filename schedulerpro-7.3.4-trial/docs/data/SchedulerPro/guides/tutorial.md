...
Next, add the bryntum dependencies. If you have the Bryntum SchedulerPro distribution, it provides pre-built JavaScript
bundles. Copy the `/build/schedulerpro.module.js`, `/build/schedulerpro.css` & `/build/svalbard-light.css` files to the
**my-schedulerpro-app** root folder.
