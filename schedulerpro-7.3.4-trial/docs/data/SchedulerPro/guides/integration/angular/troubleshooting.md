...
## The Bryntum Scheduler Pro bundle was loaded multiple times
...
## A property added to schedulerProProps has no effect
...
Angular does not process `schedulerProProps` file as a whole, but we need to use individual properties in the template.
