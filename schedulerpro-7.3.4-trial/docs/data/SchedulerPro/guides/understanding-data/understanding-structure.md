...
You can read more about the sync response structure in the [Crud Manager guide](#SchedulerPro/guides/data/crud_manager_project.md#sync-response-structure).
