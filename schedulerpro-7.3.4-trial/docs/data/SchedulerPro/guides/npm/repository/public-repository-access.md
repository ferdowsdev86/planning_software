...
|-----------------------|---------------------------------|
| Angular (IVY)         | `@bryntum/schedulerpro-angular`      |
| Angular (View Engine) | `@bryntum/schedulerpro-angular-view` |
| Angular (Thin)        | `@bryntum/schedulerpro-angular-thin` |
| React                 | `@bryntum/schedulerpro-react`        |
| React (Thin)          | `@bryntum/schedulerpro-react-thin`   |
| Vue 2.x               | `@bryntum/schedulerpro-vue`          |
| Vue 3.x               | `@bryntum/schedulerpro-vue-3`        |
| Vue 3.x (Thin)        | `@bryntum/schedulerpro-vue-3-thin`   |
