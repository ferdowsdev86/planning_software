...
```text
npm error 403 403 Forbidden - GET https://npm.bryntum.com/@bryntum/schedulerpro/-/schedulerpro-7.3.4.tgz -
npm error 403
npm error 403 --------------------------------------------------------
npm error 403                   BRYNTUM NPM REGISTRY
npm error 403 --------------------------------------------------------
npm error 403 "user..yourdomain.com" only has access for trial packages
npm error 403 It is not allowed to install licensed package "@bryntum/schedulerpro"
npm error 403 Use "@bryntum/schedulerpro-trial" package instead or contact support
npm error 403 --------------------------------------------------------
npm error 403   Npm server login guide: https://npm.bryntum.com/help
npm error 403   Get support at: https://forum.bryntum.com/
npm error 403 --------------------------------------------------------
...
[CustomerZone](https://customerzone.bryntum.com) account has no valid Bryntum Scheduler Pro license.
...
npm ERR! 404
npm ERR! 404 '@bryntum/schedulerpro@7.3.4' is not in the npm registry.
```
...
> YN0035: | @bryntum/schedulerpro@npm:7.3.4: Package not found
...
[Configure npm](#SchedulerPro/guides/npm/repository/private-repository-access.md#configure-npm) guide and reinstall the
package.
...
* Install a supported **npm** version as stated in
  [NPM requirements](#SchedulerPro/guides/npm/repository/package-managers.md#npm-requirements)
* You cannot have access to full package `@bryntum/schedulerpro` from a trial account. Use `@bryntum/schedulerpro-trial`
  package as described in 
  [Installing trial packages](#SchedulerPro/guides/npm/repository/installation.md#installing-trial-packages)
...
* If you use **yarn** please check 
  [Yarn package manager](#SchedulerPro/guides/npm/repository/package-managers.md#yarn-package-manager) information
