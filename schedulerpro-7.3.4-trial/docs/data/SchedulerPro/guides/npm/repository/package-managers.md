...
[Repository access](#SchedulerPro/guides/npm/repository/private-repository-access.md) guide. This step is mandatory. 
...
You may also [create new token](#SchedulerPro/guides/npm/repository/automation.md#creating-an-access-token).
