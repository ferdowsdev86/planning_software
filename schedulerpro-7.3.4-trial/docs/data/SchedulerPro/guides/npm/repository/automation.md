...
You may use [Access tokens](#SchedulerPro/guides/npm/repository/private-repository-access.md#access-tokens) stored in `.npmrc` in 
...
| Username       | Username for [Bryntum repository authentication](#SchedulerPro/guides/npm/repository/private-repository-access.md) |
| Password       | Password for [Bryntum repository authentication](#SchedulerPro/guides/npm/repository/private-repository-access.md) |
...
```json
"dependencies": {
  "@bryntum/schedulerpro-lib-trial": "file:./lib/bryntum-schedulerpro-lib-trial-1.0.1.tgz"  
  "@bryntum/schedulerpro": "file:./lib/bryntum-schedulerpro-trial-7.3.4.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/schedulerpro-lib": "file:./lib/bryntum-schedulerpro-lib-1.0.1.tgz"  
  "@bryntum/schedulerpro": "file:./lib/bryntum-schedulerpro-7.3.4.tgz"
}
```
</div>
</div>
