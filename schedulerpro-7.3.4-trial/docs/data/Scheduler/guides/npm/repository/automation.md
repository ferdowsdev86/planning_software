...
You may use [Access tokens](#Scheduler/guides/npm/repository/private-repository-access.md#access-tokens) stored in `.npmrc` in 
...
| Username       | Username for [Bryntum repository authentication](#Scheduler/guides/npm/repository/private-repository-access.md) |
| Password       | Password for [Bryntum repository authentication](#Scheduler/guides/npm/repository/private-repository-access.md) |
...
```json
"dependencies": {
  "@bryntum/scheduler-lib-trial": "file:./lib/bryntum-scheduler-lib-trial-1.0.1.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-trial-7.3.4.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/scheduler-lib": "file:./lib/bryntum-scheduler-lib-1.0.1.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-7.3.4.tgz"
}
```
</div>
</div>
