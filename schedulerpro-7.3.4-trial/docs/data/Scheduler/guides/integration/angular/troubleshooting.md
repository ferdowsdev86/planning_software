...
## A property added to schedulerProps has no effect
...
Angular does not process `schedulerProps` file as a whole, but we need to use individual properties in the template.
