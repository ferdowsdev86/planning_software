# Styling
The Bryntum Scheduler is rendered in the DOM using regular HTML and CSS, and can be completely styled using CSS. It ships 
with both pre-compiled CSS bundles, and the original CSS files. The CSS includes different themes and colors, 
which can be used to alter how the Scheduler and its contents look.
...
Bryntum Scheduler ships with 10 predefined event styles, each available in 20+ predefined colors. Style and color can be 
specified for the entire scheduler, per resource or per event. Event settings overrides resource, which in its turn 
overrides the scheduler setting. The following snippet shows how to assign colors:
...
![Svalbard Light theme](Scheduler/themes/thumb.svalbard-light.png "Svalbard Light theme")
![Svalbard Dark theme](Scheduler/themes/thumb.svalbard-dark.png "Svalbard Dark theme")

#### Stockholm

The Stockholm theme was our default theme prior to v7.0. It has been updated with a more modern look and feel.

![Stockholm Light theme](Scheduler/themes/thumb.stockholm-light.png "Stockholm Light theme")
![Stockholm Dark theme](Scheduler/themes/thumb.stockholm-dark.png "Stockholm Dark theme")
...
![Visby Light theme](Scheduler/themes/thumb.visby-light.png "Visby Light theme")
![Visby Dark theme](Scheduler/themes/thumb.visby-dark.png "Visby Dark theme")
...
![Material3 Light theme](Scheduler/themes/thumb.material3-light.png "Material Light theme")
![Material3 Dark theme](Scheduler/themes/thumb.material3-dark.png "Material Dark theme")
...
![Fluent2 Light theme](Scheduler/themes/thumb.fluent2-light.png "Fluent2 Light theme")
![Fluent2 Dark theme](Scheduler/themes/thumb.fluent2-dark.png "Fluent2 Dark theme")
...
The structural CSS described above include all the CSS you need to use Scheduler and its helper widgets such as Popups,
...
To create your own theme, get the [distribution bundle](#Scheduler/guides/download.md) or install the NPM package as usual and follow these steps:
...
`7.3.4` of Scheduler, you need to have the CSS files of version `7.3.4`.
...
(`scheduler.css?v=7.3.4`) or use timestamps (`scheduler.css?1704085200`).
