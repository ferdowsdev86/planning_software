...
1. `scheduler.css` – the structural CSS for Bryntum Scheduler
2. `svalbard-light.css` – a theme for Bryntum Scheduler
3. `shared.css` – styles common for all Bryntum examples that may not be needed in your application
4. `app.css` – the application specific styles. In this demo it contains only custom tooltip styles.
...
can always get help in our <a href="https://forum.bryntum.com/">support forums</a>.
