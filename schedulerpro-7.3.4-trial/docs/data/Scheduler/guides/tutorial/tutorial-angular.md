...
<div class="note">
If you are using a trial, replace <code>@bryntum/scheduler</code> with 
...
To load data remotely, configure `crudManager` with a URL to load from. Modify the previous snippet of `app.component.ts`:
