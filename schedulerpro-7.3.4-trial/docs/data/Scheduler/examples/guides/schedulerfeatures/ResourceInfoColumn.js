const scheduler = new Scheduler({
    ...
    columns : [
        { type : 'resourceInfo', field : 'name', text : 'Name', imagePath : '../examples/_shared/images/transparent-users/' }
    ],

    resources : [
        { id : 1, name : 'Bernard', imageUrl : 'arnold.png' },
        { id : 2, name : 'Bianca', imageUrl : 'gloria.png' }
    ],
